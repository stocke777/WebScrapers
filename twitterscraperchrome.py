...
def login_to_twitter(username, password, driver):
    ...
    button = driver.find_element_by_xpath('//*[@id="layers"]/div[2]/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div[6]/div/span/span')
    button.click()

    password = driver.find_element_by_xpath('//*[@id="layers"]/div[2]/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div[3]/div/label/div/div[2]/div/input')
    password.send_keys("login@twitter123")

    login = driver.find_element_by_xpath('//*[@id="layers"]/div[2]/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[2]/div/div/div/span/span')
    login.click()
    return True
...
if __name__ == '__main__':
    usr = "deshwaljaivardhan@gmail.com"
    pwd = "login@twitter123"
